...
<html>
<head>
<title>Interior Design a interior category Flat bootstrap Responsive Website Template | Gallery :: w3layouts</title>
...
<body>
	...
	<div class="header" id="header">
		...
		<div class="logo text-center">
				<h1><a href="index.jsp">Interior Design</a></h1>
			</div>
			<!-- navigation -->
...
<div class="gallery">
		<div class="container">
			<h2 class="heading text-center">Our Designs</h2>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="copyrights col-md-10">
					<p>© 2015 Interior Design. All Rights Reserved | Design by Jorta Wang</p>					
				</div>
